...
const ServicesSection = () => {
  return (
    <section >
        <h2 className=" text-5xl font-bold text-[#1F5374] text-center mb-20">الخدمات التي نقدمها</h2>

      <div className="flex gap-5 overflow-x-auto no-scrollbar lg:py-25 py-17 px-2 bg-gradient-to-r from-[#81D9FF] via-[#2C78A7] to-[#1F5374] text-center" dir="rtl">
